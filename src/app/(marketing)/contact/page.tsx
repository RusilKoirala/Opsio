...
export const metadata: Metadata = {
  title: 'Contact',
  description: 'Get in touch with Opsio - Questions, feedback, or support.',
};

const links = [
  {
    href: 'mailto:hello@rusil.me',
    icon: Mail01Icon,
    title: 'Email',
    desc: 'Send me an email for any inquiries or support requests.',
    label: 'hello@rusil.me',
  },
  {
    href: 'https://github.com/rusilkoirala',
    icon: GithubIcon,
    title: 'GitHub',
    desc: 'Check out my projects, report issues, or contribute to Opsio.',
    label: '@rusilkoirala',
    external: true,
  },
  {
  ...
  {
    href: 'https://github.com/rusilkoirala/Opsio/issues',
...
const faqs = [
  ...
  {
    q: 'Is Opsio free to use?',
    a: 'Yes, Opsio is completely free and open source. There are no paid plans or premium features.',
  },
  {
  ...
  {
    q: 'Can I contribute to Opsio?',
    a: 'Yes! Opsio is open source. Check out the GitHub repository to get started. Pull requests are welcome!',
  },
];
      ...
      <main className="mx-auto w-full max-w-4xl px-6 pt-28 pb-16">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-muted-foreground">
            Have questions about Opsio? Need help? I\'d love to hear
            from you.
          </p>
        </div>
