...
export const metadata: Metadata = {
  ...
  description:
    'Terms of Service for Opsio - Read our terms and conditions for using our service.',
};
        ...
        <div>
          ...
          <section className="mb-8">
            ...
            <p className="leading-relaxed text-muted-foreground">
              By accessing or using Opsio (&quot;Service&quot;), you agree
          ...
          <section className="mb-8">
            ...
            <p className="mb-4 leading-relaxed text-muted-foreground">
              Opsio is a web-based application that provides secure storage
          ...
          <section className="mb-8">
            ...
            <p className="mb-4 leading-relaxed text-muted-foreground">
              ...
              are owned by Rusil Koirala and are protected by international
          ...
          <section className="mb-8">
            ...
            <p className="mb-4 leading-relaxed text-muted-foreground">
              To the maximum extent permitted by law, Opsio and its creator
          ...
          <section className="mb-8">
            ...
            <p className="leading-relaxed text-muted-foreground">
              You agree to indemnify and hold harmless Opsio, its creator,
          ...
          <section className="mb-8">
            ...
            <ul className="list-none space-y-2 text-muted-foreground">
              <li>
                <strong>Email:</strong> hello@rusil.me
              </li>
              <li>
